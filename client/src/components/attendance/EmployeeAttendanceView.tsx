              ...
              {filteredLogs.length === 0 ? (
                ...
                filteredLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="py-3.5 px-4 font-mono font-medium text-slate-700">{log.checkIn || '--:--'}</td>
                    <td className="py-3.5 px-4 font-mono font-medium text-slate-700">{log.checkOut || '--:--'}</td>
