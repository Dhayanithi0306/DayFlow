...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseClasses = "w-full flex justify-center py-2.5 px-4 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2";
  ...
  return (
    <button
      className={`${baseClasses} ${variants[variant]} ${disabled || isLoading ? 'opacity-70 cursor-not-allowed' : ''} ${className}`}
